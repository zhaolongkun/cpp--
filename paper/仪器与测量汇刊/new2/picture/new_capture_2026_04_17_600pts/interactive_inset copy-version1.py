...
COLS_X = [
    ...
    ("last_value_pred_x","#7f7f7f",(1.5,1.5)),
...
COLS_Y = [
    ...
    ("last_value_pred_y","#7f7f7f",(1.5,1.5)),
...
def main():
    ...
    add_series(axes[0], frames, segment_df["last_value_pred_x"], "Last value", "#7f7f7f", (1.5, 1.5))
    ...
    add_series(axes[1], frames, segment_df["last_value_pred_y"], "Last value", "#7f7f7f", (1.5, 1.5))
